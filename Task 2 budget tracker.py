...
class BudgetTracker:
    def __init__(self, master):
        ...
        self.button_income = tk.Button(master, text="Add Income", command=self.add_income)
        self.button_expense = tk.Button(master, text="Add Expense", command=self.add_expense)

        self.button_dashboard = tk.Button(master, text="Show Dashboard", command=self.show_dashboard)
        self.button_history = tk.Button(master, text="Show Transaction History", command=self.show_history)
