...
class TodoApp:
    def __init__(self, root):
        ...
        complete_button = tk.Button(root, text="Mark Completed", command=self.mark_completed)
        complete_button.grid(row=2, column=1, padx=10, pady=10, sticky="e")

        # Save and Exit Button
        save_button = tk.Button(root, text="Save and Exit", command=self.save_and_exit)
